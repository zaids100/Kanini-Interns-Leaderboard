...
export default function LeaderboardHeader({ user, onLogout, onProfileClick, batch, setBatch, searchTerm, setSearchTerm }) {
  return (
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 focus:bg-white text-sm sm:text-base"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="cursor-pointer pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50 focus:bg-white text-sm sm:text-base appearance-none"
              >
